pipeline {
    ...
    environment {
        DOCKER_HUB_REPO = 'pj013525/techsolutions-app'
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git 'https://github.com/pj013525/microservices-ingress.git'
            }
        }
        ...
        stage('Deploy to Kubernetes') {
            steps {
                ...
                script {
                    withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'aws-creds']]) {
                        sh "sed -i 's|pj013525/techsolutions-app:latest|pj013525/techsolutions-app:${env.IMAGE_TAG}|g' k8s/deployment.yaml"
